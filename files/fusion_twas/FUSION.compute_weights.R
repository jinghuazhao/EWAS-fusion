...
option_list = list(
  ...
  make_option("--PATH_plink", action="store", default="/genetics/bin/plink-1.9 --threads 1", type='character',
              help="Path to plink executable [%default]"),
  make_option("--PATH_gcta", action="store", default="/genetics/bin/fusion_twas/gcta_nr_robust", type='character',
              help="Path to plink executable [%default]"),
